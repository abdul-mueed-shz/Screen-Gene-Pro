"object" == typeof navigator &&
  (function (e, t) {
    ...
    var y = (function () {
      function e(t, i) {
        (function (e, t) {
          ...
          g(t)
            ? (this.element = t)
            : d(t) && (this.element = document.querySelector(t)),
          g(this.element) &&
            b(this.element.rangeTouch) &&
    ...
    const v = (e) => (null != e ? e.constructor : null),
      ...
      P = (e) =>
        T(e) ||
        ((C(e) || S(e) || E(e)) && !e.length) ||
        (k(e) && !Object.keys(e).length);
    var M = T,
      N = k,
      x = (e) => v(e) === Number && !Number.isNaN(e),
      I = C,
      L = (e) => v(e) === Boolean,
      _ = A,
      O = S,
      ...
      q = (e) => w(e, Event),
      H = (e) => w(e, KeyboardEvent),
      R = (e) => w(e, TextTrack) || (!T(e) && C(e.kind)),
      F = (e) => {
    ...
    function Q(e, t, i) {
      ...
      return N(t) && Y(s, t), I(i) && (s.innerText = i), s;
    }
    function X(e, t, i, s) {
      D(t) && t.appendChild(Q(e, i, s));
    }
    function J(e) {
      j(e) || O(e)
    ...
    function te(e, t) {
      if (!D(e)) return;
      let i = t;
      L(i) || (i = !e.hidden), (e.hidden = i);
    }
    function ie(e, t, i) {
      if (j(e)) return Array.from(e).map((e) => ie(e, t, i));
      if (D(e)) {
        let s = "toggle";
        return (
    ...
    function oe(e = null, t = !1) {
      D(e) &&
        ...
        t && ie(e, this.config.classNames.tabFocus));
    }
    const re = {
        "audio/ogg": "vorbis",
        "audio/wav": "1",
      ...
      ce = {
        ...
        check(e, t, i) {
          const s = U.isIPhone && i && ce.playsinline,
            n = ce[e] || "html5" !== t;
          return {
            api: n,
            ui: n && ce.rangeInput && ("video" !== e || !U.isIPhone || s),
          };
        },
        pip: !(
          U.isIPhone ||
          (!_(Q("video").webkitSetPresentationMode) &&
    ...
    function ue(e, t, i, s = !1, n = !0, a = !1) {
      if (!e || !("addEventListener" in e) || $(t) || !_(i)) return;
      const l = t.split(" ");
      let o = a;
      he && (o = { passive: n, capture: a }),
        l.forEach((t) => {
          this &&
            this.eventListeners &&
            s &&
    ...
    function be() {
      return new Promise((e) =>
        this.ready
          ? setTimeout(e, 0)
          : de.call(this, this.elements.container, "ready", e)
      ).then(() => {});
    }
    function ye(e) {
      ((e) => w(e, Promise) && A(e.then))(e) && e.then(null, () => {});
    }
    function ve(e) {
    ...
    function Ce(e) {
      return (
        !!(O(e) || (I(e) && e.includes(":"))) &&
        (O(e) ? e : e.split(":")).map(Number).every(x)
      );
    }
    function Ae(e) {
      if (!O(e) || !e.every(x)) return null;
      const [t, i] = e,
        s = (e, t) => (0 === t ? e : s(t, e % t)),
        n = s(t, i);
      return [t / n, i / n];
      ...
      setup() {
        ...
        (e.options.speed = e.config.speed.options),
          ...
          Object.defineProperty(e.media, "quality", {
            ...
            set(t) {
              if (e.quality !== t) {
                if (e.config.quality.forced && _(e.config.quality.onChange))
                  ...
                  (e.media.src = i.getAttribute("src")),
                    ("none" !== a || l) &&
                      (e.once("loadedmetadata", () => {
                        (e.speed = o), (e.currentTime = s), n || ye(e.play());
                      }),
                      e.media.load());
                }
    ...
    const _e = {
      ...
      Oe = {
        get(e = "", t = {}) {
          if ($(e) || $(t)) return "";
          let i = W(t.i18n, e);
          if ($(i)) return Object.keys(_e).includes(e) ? _e[e] : "";
    ...
    const Fe = {
      getIconUrl() {
        const e = new URL(this.config.iconUrl, window.location),
          ...
          i = e.host !== t || (U.isIE && !window.svg4everybody);
        return { url: this.config.iconUrl, cors: i };
      },
      findElements() {
        try {
          return (
            (this.elements.controls = le.call(
              this,
            ...
            (this.elements.progress = le.call(
              this,
      ...
      createIcon(e, t) {
        ...
        Y(a, z(t, { "aria-hidden": "true", focusable: "false" }));
      ...
      createButton(e, t) {
        ...
        switch (
          ...
          Object.keys(i).includes("class")
            ? i.class
              ...
              z(i, { class: `${i.class} ${this.config.classNames.control}` })
        ...
        return (
          n.toggle
            ? (a.appendChild(
                Fe.createIcon.call(this, n.iconPressed, {
                  class: "icon--pressed",
                })
              ),
              a.appendChild(
                Fe.createIcon.call(this, n.icon, { class: "icon--not-pressed" })
              ),
              a.appendChild(
                Fe.createLabel.call(this, n.labelPressed, {
                  class: "label--pressed",
                })
              ),
              a.appendChild(
                Fe.createLabel.call(this, n.label, {
                  class: "label--not-pressed",
                })
              ))
            : (a.appendChild(Fe.createIcon.call(this, n.icon)),
              a.appendChild(Fe.createLabel.call(this, n.label))),
          z(i, ee(this.config.selectors.buttons[s], i)),
          Y(a, i),
          "play" === s
            ? (O(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
      ...
      createRange(e, t) {
        const i = Q(
          "input",
          z(
            ee(this.config.selectors.inputs[e]),
            {
              type: "range",
              min: 0,
              max: 100,
        ...
        return (
          ...
          Fe.updateRangeFill.call(this, i),
          y.setup(i),
          i
        );
      },
      createProgress(e, t) {
        const i = Q(
          "progress",
          z(
            ee(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
      ...
      createTime(e, t) {
        const i = ee(this.config.selectors.display[e], t),
          s = Q(
            "div",
            z(i, {
        ...
        de.call(
          ...
          (i) => {
            ...
            if ((i.preventDefault(), i.stopPropagation(), "keydown" === i.type))
              return;
            const s = ne(e, '[role="menuitemradio"]');
            if (!s && ["Space", "ArrowRight"].includes(i.key))
              Fe.showMenuPanel.call(this, t, !0);
            else {
              let t;
              "Space" !== i.key &&
      ...
      createMenuItem({
        ...
        const l = ee(this.config.selectors.inputs[i]),
          o = Q(
            "button",
            z(l, {
              type: "button",
            ...
            set(e) {
              e &&
                Array.from(o.parentNode.children)
                  .filter((e) => ne(e, '[role="menuitemradio"]'))
      ...
      formatTime(e = 0, t = !1) {
        return x(e) ? Re(e, He(this.duration) > 0, t) : e;
      },
      updateTimeDisplay(e = null, t = 0, i = !1) {
        D(e) && x(t) && (e.innerText = Fe.formatTime(t, i));
      },
      updateVolume() {
        this.supported.ui &&
              ...
              (s = this.currentTime),
                ...
                (t =
                  0 === s || 0 === n || Number.isNaN(s) || Number.isNaN(n)
                    ...
                    : ((s / n) * 100).toFixed(2)),
                "timeupdate" === e.type &&
                  Fe.setRange.call(this, this.elements.inputs.seek, t);
              break;
            case "playing":
            case "progress":
      ...
      updateRangeFill(e) {
        ...
        if (D(t) && "range" === t.getAttribute("type")) {
          if (ne(t, this.config.selectors.inputs.seek)) {
          ...
          } else if (ne(t, this.config.selectors.inputs.volume)) {
            const e = 100 * t.value;
      ...
      durationUpdate() {
        ...
        if (this.duration >= 2 ** 32)
          return (
            te(this.elements.display.currentTime, !0),
            void te(this.elements.progress, !0)
          );
        D(this.elements.inputs.seek) &&
        ...
        !e &&
          ...
          this.config.markers.enabled && Fe.setMarkers.call(this),
          Fe.updateSeekTooltip.call(this);
      },
      ...
      updateSetting(e, t, i) {
        ...
        if ((D(a) || (a = s && s.querySelector('[role="menu"]')), !D(a)))
          return;
        this.elements.settings.buttons[e].querySelector(
          "." + this.config.classNames.menu.value
        ).innerHTML = Fe.getLabel.call(this, e, n);
      ...
      setQualityMenu(e) {
        ...
        const s = !$(this.options.quality) && this.options.quality.length > 1;
        if (
          (Fe.toggleMenuButton.call(this, t, s),
          G(i),
        ...
        this.options.quality
          ...
          .forEach((e) => {
            Fe.createMenuItem.call(this, {
              value: e,
              list: i,
              type: t,
              title: Fe.getLabel.call(this, "quality", e),
              badge: n(e),
            });
          }),
      ...
      setCaptionsMenu() {
        ...
        const e = "captions",
          ...
          s = Boolean(i.length);
        if (
          (Fe.toggleMenuButton.call(this, e, s),
          G(t),
          Fe.checkMenu.call(this),
          !s)
        )
        ...
        const n = i.map((e, i) => ({
          ...
          title: Be.getLabel.call(this, e),
          badge:
            e.language && Fe.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: "language",
        }));
        n.unshift({
          ...
          n.forEach(Fe.createMenuItem.bind(this)),
          ...
          i &&
            (this.options.speed.forEach((i) => {
              Fe.createMenuItem.call(this, {
                ...
                list: t,
                type: e,
                title: Fe.getLabel.call(this, "speed", i),
              });
            }),
            Fe.updateSetting.call(this, e, t));
      },
      ...
      toggleMenu(e) {
        ...
        i.setAttribute("aria-expanded", n),
          te(t, !n),
          ie(this.elements.container, this.config.classNames.menu.open, n),
          n && H(e)
            ? Fe.focusFirstMenuItem.call(this, null, !0)
            : n || s || oe.call(this, i, H(e));
      },
      getMenuSize(e) {
      ...
      showMenuPanel(e = "", t = !1) {
        ...
        te(n, !0), te(i, !1), Fe.focusFirstMenuItem.call(this, i, t);
      },
      setDownloadUrl() {
      ...
      create(e) {
        ...
        const c = Q("div", ee(this.config.selectors.controls.wrapper));
        this.elements.controls = c;
        const h = { class: "plyr__controls__item" };
        return (
          ve(O(this.config.controls) ? this.config.controls : []).forEach(
            (l) => {
              if (
                ...
                const t = Q("div", {
                  ...
                  i = Q("div", ee(this.config.selectors.progress));
                if (
                  (i.appendChild(
              ...
              if (
                ...
                if (
                  ((D(t) && c.contains(t)) ||
                    ((t = Q(
                      "div",
                      z({}, h, { class: (h.class + " plyr__volume").trim() })
                    )),
                  ...
                  t.appendChild(
                    n.call(this, "volume", z(i, { id: "plyr-volume-" + e.id }))
                  );
                }
              }
              if (
                ("captions" === l && c.appendChild(i.call(this, "captions", h)),
                "settings" === l && !$(this.config.settings))
              ) {
                const s = Q(
                  "div",
                  z({}, h, {
                ...
                const n = Q("div", {
                  ...
                  a = Q("div"),
                  l = Q("div", { id: `plyr-settings-${e.id}-home` }),
                  o = Q("div", { role: "menu" });
                l.appendChild(o),
                  a.appendChild(l),
                  ...
                  this.config.settings.forEach((i) => {
                    const s = Q(
                      "button",
                      z(ee(this.config.selectors.buttons.settings), {
                        type: "button",
                    ...
                    t.call(this, s, i),
                      de.call(this, s, "click", () => {
                        r.call(this, i, !1);
                      });
                    const n = Q("span", null, Oe.get(i, this.config)),
                      l = Q("span", {
                    ...
                    h.appendChild(
                      Q("span", { "aria-hidden": !0 }, Oe.get(i, this.config))
                    ),
                      h.appendChild(
                        Q(
                          "span",
                          { class: this.config.classNames.hidden },
                          Oe.get("menuBack", this.config)
                        )
                      ),
                      de.call(
                        this,
              ...
              if (
                ("pip" === l && ce.pip && c.appendChild(i.call(this, "pip", h)),
                "airplay" === l &&
                  ce.airplay &&
                ...
                !F(t) &&
                  this.isEmbed &&
                  z(e, { icon: "logo-" + this.provider, label: this.provider }),
      ...
      inject() {
        ...
        if (
          ...
          D(this.config.controls) || I(this.config.controls)
            ? (e = this.config.controls)
            : ((e = Fe.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
          ...
          I(this.config.selectors.controls.container) &&
        ...
        if ((U.isEdge && B(i), this.config.tooltips.controls)) {
          const { classNames: e, selectors: t } = this.config,
            i = `${t.controls.wrapper} ${t.labels} .${e.hidden}`,
            s = ae.call(this, i);
          Array.from(s).forEach((e) => {
            ie(e, this.config.classNames.hidden, !1),
              ie(e, this.config.classNames.tooltip, !0);
          });
        }
      },
      setMediaMetadata() {
      ...
      setMarkers() {
        ...
        i.forEach((e) => {
          ...
          s.appendChild(n),
          this.config.tooltips.seek ||
            ((a = Q("span", { class: this.config.classNames.tooltip }, "")),
            s.appendChild(a)),
    ...
    const Be = {
        setup() {
          ...
          if (
            !this.isVideo ||
            this.isYouTube ||
            (this.isHTML5 && !ce.textTracks)
          )
            return void (
              O(this.config.controls) &&
              this.config.controls.includes("settings") &&
              this.config.settings.includes("captions") &&
              Fe.setCaptionsMenu.call(this)
            );
          var e, t;
          if (
            (D(this.elements.captions) ||
              ((this.elements.captions = Q(
                "div",
                ee(this.config.selectors.captions)
              )),
          ...
          if (
            (L(n) || ({ active: n } = this.config.captions),
            ...
            const e = this.config.captions.update
              ...
              : "removetrack";
            de.call(this, this.media.textTracks, e, Be.update.bind(this));
          }
          setTimeout(Be.update.bind(this), 0);
        },
        update() {
          const e = Be.getTracks.call(this, !0),
            {
              active: t,
              language: i,
              meta: s,
            ...
            e
              ...
              .forEach((e) => {
                this.debug.log("Track added", e),
                  ...
                  de.call(this, e, "cuechange", () => Be.updateCues.call(this));
              }),
            ((a && this.language !== i) || !e.includes(n)) &&
              (Be.setLanguage.call(this, i), Be.toggle.call(this, t && a)),
            this.elements &&
              ie(
        ...
        toggle(e, t = !0) {
          ...
          if (n !== i) {
            if (
              ...
              const e = Be.getTracks.call(this),
                t = Be.findTrack.call(
                  this,
              ...
              return (
                ...
                void Be.set.call(this, e.indexOf(t))
              );
            }
            this.elements.buttons.captions &&
              (this.elements.buttons.captions.pressed = n),
              ie(this.elements.container, s, n),
              (this.captions.toggled = n),
              Fe.updateSetting.call(this, "captions"),
              ge.call(
                this,
                this.media,
        ...
        set(e, t = !0) {
          const i = Be.getTracks.call(this);
          if (-1 !== e)
            if (x(e))
              if (e in i) {
                ...
                Be.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Be.updateCues.call(this);
        ...
        setLanguage(e, t = !0) {
          ...
          const s = Be.getTracks.call(this),
        ...
        getLabel(e) {
          ...
          return (
            !R(t) &&
              ce.textTracks &&
              this.captions.toggled &&
              (t = Be.getCurrentTrack.call(this)),
            R(t)
              ? $(t.label)
                ? $(t.language)
                  ? Oe.get("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : Oe.get("disabled", this.config)
          );
        },
        updateCues(e) {
          if (!this.supported.ui) return;
          ...
          let t = e;
          if (!t) {
            const e = Be.getCurrentTrack.call(this);
          ...
          if (i !== this.elements.captions.innerHTML) {
            ...
            const e = Q("span", ee(this.config.selectors.caption));
            (e.innerHTML = i),
        ...
        e(this, "onChange", () => {
          ...
          e(this, "toggleFallback", (e = !1) => {
            if (
              ...
              const s = I(t.content) && t.content.includes(i);
              e
          ...
          e(this, "trapFocus", (e) => {
            if (U.isIos || !this.active || "Tab" !== e.key) return;
          ...
          e(this, "exit", () => {
            if (this.enabled)
              if (U.isIos && this.player.config.fullscreen.iosNative)
                this.target.webkitExitFullscreen(), ye(this.player.play());
              else if (!Qe.native || this.forceFallback)
          ...
          de.call(this, this.player.elements.container, "keydown", (e) =>
            this.trapFocus(e)
          ),
          this.update();
      }
      ...
      static get prefix() {
        ...
        return (
          ["webkit", "moz", "ms"].some(
            (t) =>
              !(
                (!_(document[t + "ExitFullscreen"]) &&
                  !_(document[t + "CancelFullScreen"])) ||
                ((e = t), 0)
              )
          ),
          e
    ...
    const Je = {
      ...
      build() {
        ...
        D(this.elements.controls) ||
          (Fe.inject.call(this), this.listeners.controls()),
          Je.toggleNativeControls.call(this),
          this.isHTML5 && Be.setup.call(this),
          (this.volume = null),
          (this.muted = null),
          (this.loop = null),
          (this.quality = null),
          ...
          ie(
            ...
            ce.pip && this.isHTML5 && this.isVideo
          ),
          ie(
            this.elements.container,
            this.config.classNames.airplay.supported,
            ce.airplay && this.isHTML5
          ),
          ie(this.elements.container, this.config.classNames.isIos, U.isIos),
          ie(
            this.elements.container,
        ...
        ie(
          ...
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            Object.assign(e, { pressed: this.playing }),
              e.setAttribute(
                "aria-label",
                Oe.get(this.playing ? "pause" : "play", this.config)
              );
          }),
          (q(e) && "timeupdate" === e.type) || Je.toggleControls.call(this);
      },
      checkLoading(e) {
      ...
      migrateStyles() {
        Object.values({ ...this.media.style })
          .filter((e) => !$(e) && I(e) && e.startsWith("--plyr"))
          .forEach((e) => {
        ...
        e(this, "firstTouch", () => {
          ...
          e(this, "global", (e = !0) => {
            ...
            t.config.keyboard.global &&
              ue.call(t, window, "keydown keyup", this.handleKey, e, !1),
              ue.call(t, document.body, "click", this.toggleMenu, e),
              pe.call(t, document.body, "touchstart", this.firstTouch),
              ue.call(
                t,
                document.body,
          ...
          e(this, "container", () => {
            ...
            !t.keyboard.global &&
              t.keyboard.focused &&
              de.call(e, i.container, "keydown keyup", this.handleKey, !1),
              de.call(
                e,
                i.container,
                ...
                (t) => {
                  ...
                  ["touchstart", "touchmove", "mousemove"].includes(t.type) &&
                    (Je.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
            ...
            de.call(e, i.container, "enterfullscreen exitfullscreen", (t) => {
              const { target: s } = e.fullscreen;
              s === i.container &&
                ((!e.isEmbed && $(e.config.ratio)) ||
                  (n(),
                  ("enterfullscreen" === t.type ? de : me).call(
                    e,
                    window,
                    "resize",
                    a
          ...
          e(this, "media", () => {
            const { player: e } = this,
              { elements: t } = e;
            if (
              (de.call(e, e.media, "timeupdate seeking seeked", (t) =>
                Fe.timeUpdate.call(e, t)
              ),
              de.call(
                e,
                e.media,
                "durationchange loadeddata loadedmetadata",
                (t) => Fe.durationUpdate.call(e, t)
              ),
              ...
              de.call(e, e.media, "progress playing seeking seeked", (t) =>
                Fe.updateProgress.call(e, t)
              ),
              de.call(e, e.media, "volumechange", (t) =>
                Fe.updateVolume.call(e, t)
              ),
              de.call(
                e,
                e.media,
              ...
              de.call(e, e.media, "waiting canplay seeked playing", (t) =>
                Je.checkLoading.call(e, t)
              ),
              e.supported.ui && e.config.clickToPlay && !e.isAudio)
            ) {
              const i = le.call(e, "." + e.config.classNames.video);
              if (!D(i)) return;
              de.call(e, t.container, "click", (s) => {
            ...
            e.supported.ui &&
              ...
              de.call(e, e.media, "ratechange", () => {
                Fe.updateSetting.call(e, "speed"),
                  e.storage.set({ speed: e.speed });
              }),
              de.call(e, e.media, "qualitychange", (t) => {
                Fe.updateSetting.call(e, "quality", null, t.detail.quality);
              }),
              de.call(e, e.media, "ready qualitychange", () => {
                Fe.setDownloadUrl.call(e);
              });
            const i = e.config.events.concat(["keyup", "keydown"]).join(" ");
            de.call(e, e.media, i, (i) => {
              let { detail: s = {} } = i;
          ...
          e(this, "bind", (e, t, i, s, n = !0) => {
            const { player: a } = this,
              ...
              o = _(l);
            de.call(a, e, t, (e) => this.proxy(e, i, s), n && !o);
          }),
          e(this, "controls", () => {
            const { player: e } = this,
              { elements: t } = e,
            ...
            if (
                  ...
                  ["Space", "Enter"].includes(t.key) &&
                    ("Enter" !== t.key
                      ? (t.preventDefault(),
                        t.stopPropagation(),
                        Fe.toggleMenu.call(e, t))
                      : Fe.focusFirstMenuItem.call(e, null, !0));
                },
                null,
                !1
              ),
              ...
              this.bind(
                ...
                (t) => {
                  const i = t.currentTarget,
                    s = "play-on-seeked";
                  if (H(t) && !["ArrowLeft", "ArrowRight"].includes(t.key))
                    return;
                  e.lastSeekTime = Date.now();
                  const n = i.hasAttribute(s),
                    a = ["mouseup", "touchend", "keyup"].includes(t.type);
                  n && a
                    ? (i.removeAttribute(s), ye(e.play()))
              ...
              Array.from(t).forEach((e) => this.bind(e, i, (e) => B(e.target)));
            }
            this.bind(
              t.inputs.seek,
              i,
              ...
              U.isWebkit &&
                Array.from(ae.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, "input", (t) =>
                    Fe.updateRangeFill.call(e, t.target)
                  );
                }),
              ...
              this.bind(t.controls, "focusin", () => {
                ...
                ie(t.controls, i.classNames.noTransition, !0),
                  Je.toggleControls.call(e, !0),
                  setTimeout(() => {
                    ie(t.controls, i.classNames.noTransition, !1);
                  }, 0);
          ...
          if (c) {
            ...
            if (D(n)) {
              const { editable: s } = t.config.selectors,
                { seek: a } = i.inputs;
              if (n !== a && ne(n, s)) return;
              if ("Space" === e.key && ne(n, 'button, [role^="menuitem"]'))
                return;
            }
            switch (
              ([
            ...
            function r(e, i, s) {
              ...
              function c(t, i) {
                o(
                  e,
                  function (e) {
                    a(r, e), t && a({ success: t, error: i }, e), n(l, e);
                  },
                  r
                );
              }
    ...
    const it = {
      setup() {
        const e = this;
        ie(e.elements.wrapper, e.config.classNames.embed, !0),
          (e.options.speed = e.config.speed.options),
          Ee.call(e),
          N(window.Vimeo)
            ? it.ready.call(e)
      ...
      ready() {
        ...
        if (
          ...
          $(s) || u.setAttribute("referrerPolicy", s),
          i || !t.customControls)
        )
        ...
        Object.defineProperty(e.media, "volume", {
          ...
          set(t) {
            e.embed.setVolume(t).then(() => {
              (g = t), ge.call(e, e.media, "volumechange");
            });
          },
        });
        ...
        Object.defineProperty(e.media, "muted", {
          ...
          set(t) {
            ...
            e.embed.setVolume(i ? 0 : e.config.volume).then(() => {
              (f = i), ge.call(e, e.media, "volumechange");
            });
          },
        });
        let b,
        ...
        Object.defineProperty(e.media, "loop", {
          get: () => y,
          set(t) {
            const i = L(t) ? t : e.config.loop.active;
          ...
          Promise.all([e.embed.getVideoWidth(), e.embed.getVideoHeight()]).then(
            (t) => {
              const [i, s] = t;
              (e.embed.ratio = Pe(i, s)), Ee.call(this);
            }
          ),
          ...
          e.embed.getCurrentTime().then((t) => {
            (m = t), ge.call(e, e.media, "timeupdate");
          }),
    ...
    const at = {
        setup() {
          if (
            ...
            N(window.YT) && _(window.YT.Player))
          )
            at.ready.call(this);
          else {
            const e = window.onYouTubeIframeAPIReady;
            (window.onYouTubeIframeAPIReady = () => {
              _(e) && e(), at.ready.call(this);
            }),
        ...
        ready() {
          ...
          $(s) && (s = e.media.getAttribute(this.config.attributes.embed.id));
          const n = $((a = s))
            ? null
            : a.match(
          ...
          if (((e.media = Z(l, e.media)), t.customControls)) {
            ...
            events: {
              ...
              onReady(i) {
                ...
                (e.options.speed = o.filter((t) =>
                  ...
                  t.customControls && setTimeout(() => Je.build.call(e), 50);
              },
              onStateChange(i) {
                const s = i.target;
                switch (
          ...
          this.media
            ? (ie(
              ...
              this.isVideo &&
                ...
                K(this.media, this.elements.wrapper),
        ...
        e(this, "load", () => {
            ...
            () =>
              new Promise((e) => {
                ...
                if (_(t))
                  ...
                  const e = (I(t) ? [t] : t).map((e) => this.getThumbnail(e));
          ...
          e(
            ...
            (e) =>
              new Promise((t) => {
                De(e).then((i) => {
                  const s = { frames: ct(i), height: null, urlPrefix: "" };
            ...
            if (
              ...
              if ("touchmove" === e.type)
                ...
                (this.seekTime = this.player.media.duration * (n / 100)),
                  ...
                  (this.elements.thumb.time.innerText = Re(this.seekTime));
                const a =
            ...
            this.destroy.call(
              ...
              () => {
                ...
                Object.assign(this, {
                  provider: s,
                  type: i,
                  supported: ce.check(i, s, this.config.playsinline),
                  media: Q(a, l),
                }),
                  this.elements.container.appendChild(this.media),
                  L(e.autoplay) && (this.config.autoplay = e.autoplay),
                  this.isHTML5 &&
    ...
    class mt {
      constructor(t, i) {
        if (
            ...
            _(this.media.play)
              ? (this.ads &&
                  ...
                  this.ads.managerPromise
                    .then(() => this.ads.play())
                    .catch(() => ye(this.media.play())),
                this.media.play())
              : null
          ),
          e(this, "pause", () =>
            this.playing && _(this.media.pause) ? this.media.pause() : null
          ),
          e(this, "togglePlay", (e) =>
            (L(e) ? e : !this.playing) ? this.play() : this.pause()
          ),
          e(this, "stop", () => {
            this.isHTML5
              ? (this.pause(), this.restart())
              : _(this.media.stop) && this.media.stop();
          }),
          e(this, "restart", () => {
            this.currentTime = 0;
          }),
          e(this, "rewind", (e) => {
            this.currentTime -= x(e) ? e : this.config.seekTime;
          }),
          e(this, "forward", (e) => {
            this.currentTime += x(e) ? e : this.config.seekTime;
          }),
          e(this, "increaseVolume", (e) => {
            ...
            this.volume = t + (x(e) ? e : 0);
          }),
          e(this, "decreaseVolume", (e) => {
            this.increaseVolume(-e);
          }),
          e(this, "airplay", () => {
            ce.airplay && this.media.webkitShowPlaybackTargetPicker();
          }),
          ...
          e(this, "supports", (e) => ce.mime.call(this, e)),
          (this.timers = {}),
          (this.ready = !1),
          (this.loading = !1),
          (this.failed = !1),
        ...
        switch (n) {
          case "div":
            ...
            if ($(this.provider) || !Object.values(ze).includes(this.provider))
          ...
          this.supported.api
            ? ((this.eventListeners = []),
              ...
              D(this.elements.container) ||
                ...
                K(this.media, this.elements.container)),
              ...
              this.isHTML5 &&
                this.config.autoplay &&
                this.once("canplay", () => ye(this.play())),
              (this.lastSeekTime = 0),
              this.config.previewThumbnails.enabled &&
                (this.previewThumbnails = new ut(this)))
      ...
      set volume(e) {
        let t = e;
        I(t) && (t = Number(t)),
          x(t) || (t = this.storage.get("volume")),
          x(t) || ({ volume: t } = this.config),
          t > 1 && (t = 1),
          t < 0 && (t = 0),
      ...
      set muted(e) {
        let t = e;
        L(t) || (t = this.storage.get("muted")),
          L(t) || (t = this.config.muted),
          (this.config.muted = t),
          (this.media.muted = t);
      }
      get muted() {
      ...
      set speed(e) {
        let t = null;
        x(e) && (t = e),
          x(t) || (t = this.storage.get("speed")),
          x(t) || (t = this.config.speed.selected);
      ...
      set loop(e) {
        const t = L(e) ? e : this.config.loop.active;
      ...
      get ratio() {
        ...
        const e = Ae(Se.call(this));
        return O(e) ? e.join(":") : e;
      }
      set ratio(e) {
        this.isVideo
          ? I(e) && Ce(e)
            ? ((this.config.ratio = Ae(e)), Ee.call(this))
            : this.debug.error(`Invalid aspect ratio specified (${e})`)
          : this.debug.warn("Aspect ratio can only be set for video");
      }
      set autoplay(e) {
        this.config.autoplay = L(e) ? e : this.config.autoplay;
      }
      get autoplay() {
      ...
      set currentTrack(e) {
        Be.set.call(this, e, !1), Be.setup.call(this);
      }
      get currentTrack() {
      ...
      set pip(e) {
        if (!ce.pip) return;
        const t = L(e) ? e : !this.pip;
        _(this.media.webkitSetPresentationMode) &&
          this.media.webkitSetPresentationMode(t ? We : "inline"),
          _(this.media.requestPictureInPicture) &&
            (!this.pip && t
      ...
      static setup(e, t = {}) {
        ...
        return (
          I(e)
            ...
            ? (i = Array.from(e))
            : O(e) && (i = e.filter(D)),
          $(i) ? null : i.map((e) => new mt(e, t))
        );
      }
    }
    var pt;
    return (mt.defaults = ((pt = Ue), JSON.parse(JSON.stringify(pt)))), mt;
  });
